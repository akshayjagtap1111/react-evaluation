...
export default function AddCity() {
  ...
  const handleadd = (e) => {
    axios.post("http://localhost:8080/city",mycity).then((res)=>{
        ...
        dispatch(add_city_success(mycity))
        setmycity(initial)
    });
  };
  ...
  return (
    <div>
      <input type="text" placeholder="city name" name="Cityname" onChange={handlechange} value={Cityname}/>
      <input type="text" placeholder="Population" name="Population" onChange={handlechange} value={Population}/>
